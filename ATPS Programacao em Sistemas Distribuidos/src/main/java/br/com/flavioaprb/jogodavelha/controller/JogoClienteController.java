	...
	public void initialize(URL url, ResourceBundle bundle) {
		...
		btn1.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				logicaCliente.executarJogada(btn1, 0, 0, jogo, simbolo,
						listaBotoes);
			}
		});
		...
		btn2.setOnAction(new EventHandler<ActionEvent>() {
			@Override
			public void handle(ActionEvent event) {
				logicaCliente.executarJogada(btn2, 0, 1, jogo, simbolo,
						listaBotoes);
			}
		});
		...
		btn3.setOnAction(new EventHandler<ActionEvent>() {
			@Override
			public void handle(ActionEvent event) {
				logicaCliente.executarJogada(btn3, 0, 2, jogo, simbolo,
						listaBotoes);
			}
		});
		...
		btn4.setOnAction(new EventHandler<ActionEvent>() {
			@Override
			public void handle(ActionEvent event) {
				logicaCliente.executarJogada(btn4, 1, 0, jogo, simbolo,
						listaBotoes);
			}
		});
		...
		btn5.setOnAction(new EventHandler<ActionEvent>() {
			@Override
			public void handle(ActionEvent event) {
				logicaCliente.executarJogada(btn5, 1, 1, jogo, simbolo,
						listaBotoes);
			}
		});
		...
		btn6.setOnAction(new EventHandler<ActionEvent>() {
			@Override
			public void handle(ActionEvent event) {
				logicaCliente.executarJogada(btn6, 1, 2, jogo, simbolo,
						listaBotoes);
			}
		});
		...
		btn7.setOnAction(new EventHandler<ActionEvent>() {
			@Override
			public void handle(ActionEvent event) {
				logicaCliente.executarJogada(btn7, 2, 0, jogo, simbolo,
						listaBotoes);
			}
		});
		...
		btn8.setOnAction(new EventHandler<ActionEvent>() {
			@Override
			public void handle(ActionEvent event) {
				logicaCliente.executarJogada(btn8, 2, 1, jogo, simbolo,
						listaBotoes);
			}
		});
		...
		btn9.setOnAction(new EventHandler<ActionEvent>() {
			@Override
			public void handle(ActionEvent event) {
				logicaCliente.executarJogada(btn9, 2, 2, jogo, simbolo,
						listaBotoes);
			}
		});
